...
exports.hasTranslation = exports.translate = exports.mockTranslations = void 0;
exports.mockTranslations = {
  en: {
    // Common UI elements
    'common.save': 'Save',
...
const translate = (key, params = {}, lang = 'en') => {
  const translations = exports.mockTranslations[lang === 'fr' ? 'fr' : 'en'];
...
const hasTranslation = (key, lang = 'en') => {
  const translations = exports.mockTranslations[lang === 'fr' ? 'fr' : 'en'];
