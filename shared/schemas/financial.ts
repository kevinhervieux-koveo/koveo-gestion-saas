...
export const insertBillSchema = z.object({
  ...
  category: z.enum(['administration', 'cleaning', 'insurance', 'landscaping', 'maintenance', 'professional_services', 'repairs', 'reserves', 'salary', 'security', 'supplies', 'taxes', 'technology', 'utilities', 'other']),
