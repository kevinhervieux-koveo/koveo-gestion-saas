...
const enhancedPackageJson = {
  ...
  version: '1.0.0',
  description:
    'Professional property management platform for Quebec with bilingual support, tenant portals, and automated communications',
  type: 'module',
  license: 'MIT',
  author: {
  ...
  scripts: {
    ...
    'quality:complexity':
      'npx complexity-report --format json client/src/**/*.{ts,tsx} server/**/*.{ts,tsx}',
    validate: 'npm run validate:all',
    'validate:all':
      'npm run lint:check && npm run format:check && npm run typecheck && npm run test && npm run quality:check',
    ...
    'docs:generate':
      "typedoc --out docs --entryPoints client/src server --exclude '**/node_modules/**' --exclude '**/tests/**' --name 'Koveo Gestion Documentation'",
