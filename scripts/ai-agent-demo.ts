...
async function runDemo() {
  ...
  try {
    ...
    console.warn(chalk.green(`   ✅ Memory usage: ${Math.round(health.system.memory.heapUsed / 1024 / 1024)}MB`));
    ...
    console.warn(chalk.white('   • Enhanced Agent Orchestrator initialized with real-time monitoring'));
    ...
    console.warn(chalk.blue.bold('\n🔗 Next Steps:'));
    console.warn(chalk.cyan('   • Start real-time monitoring: npx tsx scripts/enhanced-ai-agent-cli.ts start --watch --dashboard'));
    console.warn(chalk.cyan('   • Open dashboard: open replit-dashboard.html'));
    console.warn(chalk.cyan('   • Run interactive CLI: npx tsx scripts/enhanced-ai-agent-cli.ts task --interactive'));
    console.warn(chalk.cyan('   • Generate reports: npx tsx scripts/enhanced-ai-agent-cli.ts report --format html'));
