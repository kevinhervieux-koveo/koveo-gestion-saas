...
async function testRBAC() {
  ...
  console.warn(
    `- 563 montée des pionniers: ${managerCanAccessProperty ? '❌ (Unexpected)' : '✅ (Expected)'}`
  );
  ...
  console.warn(
    `- 563 montée des pionniers: ${tenantCanAccessProperty ? '❌ (Unexpected)' : '✅ (Expected)'}`
  );
  ...
  console.warn(
    '✅ Normal organizations (563 montée des pionniers) can only access themselves + Demo'
  );
