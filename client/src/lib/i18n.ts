...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    adminManagerResidentTenant: 'Super Admin → Admin → Manager → Resident → Tenant',
  ...
  fr: {
    ...
    adminManagerResidentTenant: 'Super administrateur → Administrateur → Gestionnaire → Résident → Locataire',
