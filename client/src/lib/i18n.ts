...
const translations: Record<Language, Translations> = {
  en: {
    ...
    quebecComplianceDesc: 'Built-in compliance with Quebec Law 25 and property management regulations. Strong data protection measures implemented.',
  ...
  fr: {
    ...
    quebecComplianceDesc: 'Conformité intégrée avec la Loi 25 du Québec et les règlements de gestion immobilière. Mesures robustes de protection des données mises en place.',
