...
const translations: Record<Language, Translations> = {
  ...
  fr: {
    ...
    // Traductions des pages d'administration
    ...
    userFeedbackSuggestions: 'Commentaires d\'utilisateurs et suggestions',
    ...
    accessDenied: 'Accès refusé',
    roleAssignmentFailed: 'Échec de l\'attribution du rôle',
    ...
    evaluationImpactViePrivee: 'Évaluation d\'impact sur la vie privée',
