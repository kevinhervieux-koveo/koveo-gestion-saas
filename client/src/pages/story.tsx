  ...
  const timeline = [
    {
      ...
      description:
        "Création de l'entreprise avec pour mission de moderniser la gestion immobilière au Québec.",
      icon: Lightbulb,
    },
    {
      year: '2024',
      ...
      description:
        'Conception et développement de notre solution complète en conformité avec la Loi 25 du Québec.',
      icon: Building,
    },
    {
      year: '2025',
      ...
      <section className='container mx-auto px-4 py-16 text-center'>
        <div className='max-w-4xl mx-auto'>
          ...
          <p className='text-xl text-gray-600 mb-8 leading-relaxed'>
            Découvrez notre mission de moderniser la gestion immobilière au Québec avec des
            solutions technologiques respectueuses de la réglementation locale.
          </p>
        </div>
      </section>
                  ...
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      ...
                      <CardDescription className='text-blue-700'>
                        {companyHistory.fileInfo.name} •{' '}
                        {Math.round(companyHistory.fileInfo.size / 1024)} KB
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className='flex items-center justify-between'>
                    <p className='text-blue-800'>
                      {companyHistory.message ||
                        "Document d'histoire complet disponible en téléchargement"}
                    </p>
                  ...
                  {companyHistory.fileInfo.lastModified && (
                    <p className='text-sm text-blue-600 mt-2'>
                      ...
                      {new Date(companyHistory.fileInfo.lastModified).toLocaleDateString('fr-CA')}
                    </p>
                  )}
                </CardContent>
              </Card>
                ...
                {companyHistory.content.title && (
                  <div className='text-center'>
                    ...
                    {companyHistory.content.subtitle && (
                      <p className='text-xl text-gray-600'>{companyHistory.content.subtitle}</p>
                    )}
                  </div>
                )}
                  ...
                  <div className='grid gap-6'>
                    {companyHistory.content.sections.map((section: any, index: number) => (
                      <Card
                        ...
                        data-testid={`history-section-${index}`}
                      >
                        <CardHeader>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-lg text-gray-600 mb-6'>
                ...
                au Québec en offrant une plateforme technologique moderne, sécurisée et conforme aux
                réglementations locales.
              </p>
              <p className='text-lg text-gray-600 mb-6'>
                Nous croyons que les gestionnaires immobiliers du Québec méritent des outils qui
                comprennent leurs défis spécifiques, respectent les lois locales et parlent leur
                langue.
              </p>
            ...
            <div className='bg-blue-50 p-8 rounded-lg'>
              ...
              <p className='text-gray-700'>
                Devenir la plateforme de référence pour la gestion immobilière au Québec en
                combinant innovation technologique et respect des particularités locales.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              Depuis notre création, nous nous concentrons sur le développement d'une solution
            ...
            <div className='grid md:grid-cols-2 gap-12 items-center'>
              ...
              <div className='bg-white p-8 rounded-lg shadow-sm'>
                ...
                <p className='text-gray-600 mb-4'>
                  Nous nous engageons à comprendre les défis uniques de la gestion immobilière au
                  Québec et à développer des solutions qui respectent votre contexte réglementaire.
                </p>
                <p className='text-gray-600'>
                  Notre équipe combine expertise technique et connaissance approfondie du marché
        ...
        <div className='container mx-auto px-4 text-center'>
          <div className='max-w-3xl mx-auto'>
            ...
            <p className='text-lg mb-8 text-blue-100'>
              Nous continuons à développer notre plateforme en écoutant nos clients et en anticipant
              leurs besoins futurs. Notre objectif est de rester à la pointe de l'innovation tout en
              maintenant notre engagement envers la conformité québécoise.
            </p>
