          ...
          <div className="flex items-center space-x-4">
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <Link href="/features" data-testid="nav-features">
                <span className="text-gray-600 hover:text-blue-600 cursor-pointer">Fonctionnalités</span>
              </Link>
              ...
              <Link href="/story" data-testid="nav-story">
                <span className="text-blue-600 font-medium cursor-pointer">Notre histoire</span>
              </Link>
            </nav>
          </div>
