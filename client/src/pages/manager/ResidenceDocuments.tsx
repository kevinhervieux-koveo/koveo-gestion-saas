...
export default function ResidenceDocuments({ residenceId }: ResidenceDocumentsProps) {
  ...
  const { data: residence } = useQuery({
    ...
    queryFn: () => residenceId ? apiRequest("GET", `/api/residences/${residenceId}`) as Promise<any> : Promise.resolve(null),
    enabled: !!residenceId,
  });
  ...
  const { data: building } = useQuery({
    ...
    queryFn: () => residence?.buildingId ? apiRequest("GET", `/api/buildings/${residence.buildingId}`) as Promise<any> : Promise.resolve(null),
              ...
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Add a new document to this residence. You can attach a file or create a document entry only.
                    </DialogDescription>
                  </DialogHeader>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700">
                          {DOCUMENT_CATEGORIES.find(cat => cat._value === selectedDocument.type)?.label || selectedDocument.type}
                        </p>
                      </div>
                      <div>
                      ...
                      {selectedDocument.fileUrl && (
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-700">{selectedDocument.fileName}</span>
                            <Button
                              size="sm"
                              variant="outline"
                              onClick={() => window.open(getDisplayableFileUrl(selectedDocument.fileUrl!), '_blank')}
                            >
