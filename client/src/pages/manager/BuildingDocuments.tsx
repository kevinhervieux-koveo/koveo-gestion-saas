...
export default function BuildingDocuments({ buildingId }: BuildingDocumentsProps) {
  ...
  const handleFileUploadComplete = (documentId: string) => (result: UploadResult<any, any>) => {
    ...
    if (uploadedFile && uploadedFile.uploadURL) {
      ...
      toast({
        title: "Success",
        description: "File uploaded and attached to document successfully.",
      });
    }
  };
              ...
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Add a new document to this building. You can attach a file or create a document entry only.
                    </DialogDescription>
                  </DialogHeader>
