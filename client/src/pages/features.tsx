  ...
  const coreFeatures = [
    {
      ...
      description: "Supervisez tous vos bâtiments avec suivi des maintenances, gestion des résidents, et surveillance de la conformité réglementaire québécoise.",
      features: [
    ...
    },
    {
      ...
      description: "Portail en libre-service pour les résidents afin de consulter les factures, soumettre des demandes, et communiquer avec la gestion immobilière.",
      features: [
    ...
    },
    {
      ...
      description: "Analyses financières approfondies, suivi budgétaire, et rapports conformes aux réglementations québécoises pour la transparence.",
      features: [
    ...
    },
    {
      ...
      description: "Conformité intégrée à la Loi 25 du Québec et aux réglementations de gestion immobilière. Protection des données garantie.",
      features: [
  ...
  const quebecCompliance = [
    {
      ...
      description: "Conformité complète aux exigences de protection des données personnelles du Québec"
    },
    {
