        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/features" className="text-gray-600 hover:text-koveo-navy transition-colors">
                {t('features')}
              </Link>
              <Link href="/pricing" className="text-koveo-navy font-medium">
                {t('pricing')}
              </Link>
              <Link href="/security" className="text-gray-600 hover:text-koveo-navy transition-colors">
                {t('security')}
              </Link>
              {isAuthenticated ? (
                <Button onClick={() => setLocation('/dashboard/quick-actions')} data-testid="nav-dashboard">
                  {t('goToDashboard')}
                </Button>
              ) : (
            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                <div className="text-5xl font-bold text-koveo-navy mb-2">
                  $9.50 <span className="text-lg font-normal text-gray-600">CAD</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8">
              {t('featuresOverviewDesc')}
            </p>
            <Link href="/features">
              <Button variant="outline" className="border-koveo-navy text-koveo-navy hover:bg-koveo-navy hover:text-white">
                {t('viewAllFeatures')}
