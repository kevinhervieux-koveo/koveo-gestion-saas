...
import { Maximize2, Minimize2, Home, FileText, Wrench, DollarSign, MessageSquare } from 'lucide-react';
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Elevator maintenance finished - Unit 4B</p>
                  </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Pool maintenance scheduled for next week</p>
                  </div>
