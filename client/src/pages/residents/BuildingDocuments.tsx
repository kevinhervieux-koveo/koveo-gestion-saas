...
import { FileText, Download, Calendar, ArrowLeft, Building, MapPin, Search } from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <div className='flex-1 flex flex-col overflow-hidden'>
        <Header title='Building Documents' subtitle='Loading documents...' />
  ...
  return (
    <div className='flex-1 flex flex-col overflow-hidden'>
      <Header
        ...
        subtitle={
          isUserTenant ? 'View documents available to tenants' : 'Building documents and resources'
        }
      />
        ...
        <div className='max-w-6xl mx-auto space-y-6'>
          ...
          <div className='flex justify-between items-center'>
            ...
            <p className='text-sm text-muted-foreground'>
              {isUserTenant ? 'Showing documents available to tenants' : 'All building documents'}
            </p>
          </div>
                ...
                >
                  <CardHeader>
                    ...
                    <Badge variant='outline' className='w-fit'>
                      {BUILDING_DOCUMENT_CATEGORIES.find((cat) => cat._value === document.type)
                        ?.label || document.type}
                    </Badge>
                  </CardHeader>
                  <CardContent>
