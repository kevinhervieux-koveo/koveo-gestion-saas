        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose max-w-none">
            ...
            <p className="text-gray-700 mb-8">
              Ces conditions d'utilisation régissent votre accès et votre utilisation de la plateforme 
              Koveo Gestion, un service de gestion immobilière conçu pour le marché québécois.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. Acceptation des conditions</h2>
            <p className="text-gray-700 mb-6">
              En accédant ou en utilisant notre plateforme, vous acceptez d'être lié par ces conditions 
              d'utilisation et notre politique de confidentialité. Si vous n'acceptez pas ces conditions, 
            ...
            <p className="text-gray-700 mb-6">
              ...
              relatifs au service, y compris les logiciels, contenus, marques et designs. 
              Vous conservez la propriété de vos données, mais nous accordez une licence d'utilisation 
              nécessaire pour fournir le service.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Confidentialité et données</h2>
            <p className="text-gray-700 mb-6">
              Notre traitement de vos données personnelles est régi par notre politique de confidentialité, 
              qui respecte la Loi 25 du Québec. Vous vous engagez à respecter la confidentialité des 
              informations d'autres utilisateurs auxquelles vous pourriez avoir accès.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Paiements et facturation</h2>
            <p className="text-gray-700 mb-4">
              Les conditions de paiement comprennent :
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-6">
            ...
            <p className="text-gray-700 mb-6">
              Nous nous efforçons de maintenir une haute disponibilité du service, mais ne garantissons 
              pas un accès ininterrompu. Nous pouvons effectuer des maintenances programmées avec 
              préavis raisonnable.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Limitation de responsabilité</h2>
            <p className="text-gray-700 mb-6">
              Dans les limites permises par la loi québécoise, notre responsabilité est limitée au montant 
              payé pour le service au cours des 12 derniers mois. Nous ne sommes pas responsables des 
            ...
            <p className="text-gray-700 mb-6">
              ...
              Tout différend sera soumis à la juridiction exclusive des tribunaux du Québec.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4">12. Modifications</h2>
            <p className="text-gray-700 mb-6">
              Nous nous réservons le droit de modifier ces conditions occasionnellement. 
              Les modifications importantes seront communiquées par courriel avec un préavis de 30 jours.
            </p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              <p className="text-gray-700">
                <strong>Service client Koveo Gestion</strong><br/>
                Courriel : support@koveogestion.com<br/>
