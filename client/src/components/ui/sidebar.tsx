...
>(
  (
    ...
    const toggleSidebar = React.useCallback(() => {
      const toggleAction = isMobile ? setOpenMobile : setOpen;
      toggleAction((prev) => !prev);
    }, [isMobile, setOpen, setOpenMobile]);

    const isToggleKeyPressed = React.useCallback((event: KeyboardEvent) => {
    ...
    }, [toggleSidebar, isToggleKeyPressed]);
...
>(
  (
    ...
    const getDesktopSidebarClasses = () => {
      const isFloatingOrInset = variant === 'floating' || variant === 'inset';
      return cn(
    ...
    const renderDesktopSidebar = () => (
      <div
        ...
        data-side={side}
      >
        <div className={getGapClasses()} />
        <div className={getDesktopSidebarClasses()} {...props}>
          <div
            data-sidebar='sidebar'
