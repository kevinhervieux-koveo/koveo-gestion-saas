      ...
      <Card>
        <CardHeader className='pb-4'>
          <div className='flex items-center justify-between'>
            <CardTitle className='text-lg font-semibold'>{t('invitationsList')}</CardTitle>
                ...
                {invitations.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={7} className='text-center py-8'>
                      <div className='text-muted-foreground'>{t('noInvitationsFound')}</div>
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>{t('cancelInvitationConfirmation')}</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
