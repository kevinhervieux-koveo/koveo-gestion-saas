            ...
            <div className="space-y-3">
              ...
              {selectedFilter && (
                ...
                >
                  ...
                  <SelectContent>
                    {(selectedFilter.operators || getDefaultOperators(selectedFilter.type)).map(op => (
              ...
              <Button 
                ...
                disabled={!selectedFilter || !filterOperator || 
