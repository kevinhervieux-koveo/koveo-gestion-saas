...
export default function ModularBillForm({ bill, isTemplate = false, onSuccess, onCancel, buildingId }: ModularBillFormProps) {
  ...
  // Debug: Log template bill data
  console.log('🔍 [BILL_FORM] Template debug:', {
    isTemplate,
    billId: bill?.id,
    isAutoGenerated: bill?.isAutoGenerated,
    paymentType: bill?.paymentType,
    parsedRecurrence: parsedPaymentData.recurrence,
    shouldPreCheckRecurrence: (isTemplate && bill?.isAutoGenerated)
  });
