              ...
              <CardContent>
                {templates.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 mb-2">No recurrent bills available as templates</p>
                    <p className="text-sm text-gray-400">
                      Create a recurrent bill first to use it as a template
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    <p className="text-sm text-gray-600 mb-4">
                      Select a recurrent bill to use as a template. All data will be copied and you can edit it as needed.
                    </p>
                          ...
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-500 mt-1">#{template.billNumber}</p>
                                ...
                                <div className="flex items-center gap-4 mt-2">
                                  <span className="text-sm font-medium">
                                    ${Number(template.totalAmount).toLocaleString()}
                                  </span>
                                  <Badge variant="outline" className="text-xs">
                                    {template.category}
                                  </Badge>
                                  <Badge variant="secondary" className="text-xs">
                                    {template.schedulePayment}
                                  </Badge>
                                </div>
                              </div>
                              {selectedTemplate?.id === template.id && (
                    ...
                    {selectedTemplate && (
                      <div className="mt-4 p-3 bg-green-50 dark:bg-green-950/20 rounded-md border border-green-200 dark:border-green-800">
                        <p className="text-sm text-green-700 dark:text-green-300">
                          ✅ Template "{selectedTemplate.title}" applied to the form below. You can edit any field as needed.
                        </p>
                      </div>
                    )}
                  </div>
