...
export const helpContentMap: Record<string, HelpContent> = {
  ...
  '/manager/common-spaces-stats': {
    ...
    buttons: [
      { label: { en: 'Building', fr: 'Immeuble' }, description: { en: 'Return to building selection to choose a different building', fr: 'Retourner à la sélection d\'immeuble pour choisir un immeuble différent' } },
      ...
      { label: { en: 'edit space', fr: 'modifier espace' }, description: { en: 'Modify the selected common space details and settings', fr: 'Modifier les détails et paramètres de l\'espace commun sélectionné' } },
