  ...
  describe('Hamburger Menu Navigation', () => {
    ...
    it('should expand navigation menu when hamburger is tapped', async () => {
      const {
        ...
        SheetHeader,
        SheetTitle,
      } = require('../../client/src/components/ui/sheet');
      const { Button } = require('../../client/src/components/ui/button');
  ...
  describe('Tab Navigation', () => {
    it('should implement swipeable tabs for property sections', async () => {
      const {
        ...
        TabsTrigger,
        TabsContent,
      } = require('../../client/src/components/ui/tabs');
  ...
  describe('Breadcrumb Navigation', () => {
    it('should provide collapsible breadcrumbs for mobile', () => {
      const {
        ...
        BreadcrumbSeparator,
        BreadcrumbPage,
      } = require('../../client/src/components/ui/breadcrumb');
  ...
  describe('Floating Action Button', () => {
    ...
    it('should show quick action menu from FAB', async () => {
      const {
        ...
        DropdownMenuContent,
        DropdownMenuItem,
      } = require('../../client/src/components/ui/dropdown-menu');
      const { Button } = require('../../client/src/components/ui/button');

      render(
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className='fixed bottom-20 right-4 h-14 w-14 rounded-full shadow-lg' size='lg'>
              +
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent side='top' align='end' className='mb-2'>
            <DropdownMenuItem>🏢 Add Building</DropdownMenuItem>
            <DropdownMenuItem>👤 Add Resident</DropdownMenuItem>
    ...
    it('should provide back button for deep navigation', () => {
      ...
      render(
        <header className='flex items-center p-4 border-b'>
          <Button variant='ghost' size='sm' className='mr-2' aria-label='Go back'>
            ←
          </Button>
