    ...
    const defaultSelectMock = {
      from: jest.fn<any>().mockReturnValue({
        where: jest.fn<any>().mockReturnValue({
          limit: jest.fn<any>().mockResolvedValue([] as any), // No existing auto-generated bills by default
  ...
  describe('Bill Querying and Filtering', () => {
    ...
    it('should filter bills by category', async () => {
      ...
      (mockDb.select as any).mockReturnValue({
        from: jest.fn<any>().mockReturnValue({
          where: jest.fn<any>().mockReturnValue({
            orderBy: jest.fn<any>().mockResolvedValue(insuranceBills as any),
          }),
        }),
      });
    ...
    it('should filter bills by status', async () => {
      ...
      (mockDb.select as any).mockReturnValue({
        from: jest.fn<any>().mockReturnValue({
          where: jest.fn<any>().mockReturnValue({
            orderBy: jest.fn<any>().mockResolvedValue(paidBills as any),
          }),
        }),
      });
    ...
    it('should filter bills by year', async () => {
      (mockDb.select as any).mockReturnValue({
        from: jest.fn<any>().mockReturnValue({
          where: jest.fn<any>().mockReturnValue({
            orderBy: jest.fn<any>().mockResolvedValue(testBills as any),
          }),
        }),
      });
  ...
  describe('Auto-Generation Workflow', () => {
    it('should link generated bills to source template', async () => {
      ...
      (mockDb.select as any).mockReturnValue({
        from: jest.fn<any>().mockReturnValue({
          where: jest.fn<any>().mockReturnValue({
            orderBy: jest.fn<any>().mockResolvedValue(generatedBills as any),
          }),
        }),
      });
