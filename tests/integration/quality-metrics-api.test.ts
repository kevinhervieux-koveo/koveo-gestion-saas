...
describe('Quality Metrics API Integration Tests', () => {
  ...
  describe('GET /api/quality-metrics', () => {
    ...
    it('should return consistent results on multiple calls', async () => {
      const response1 = await request(app).get('/api/quality-metrics').expect(200);

      const response2 = await request(app).get('/api/quality-metrics').expect(200);
  ...
  describe('Quality Metrics Performance', () => {
    it('should return metrics within reasonable time', async () => {
      ...
      await request(app).get('/api/quality-metrics').expect(200);
