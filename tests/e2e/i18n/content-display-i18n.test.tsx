    ...
    <div className="p-6" data-testid="demands-list-container">
      ...
      <div className="mb-4" data-testid="results-summary">
        <p className="text-gray-600">
          {t.showing} <span className="font-medium">1-{demands.length}</span> {t.of} <span className="font-medium">{demands.length}</span> {t.results}
        </p>
      </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-600">
              ...
              <div data-testid={`submitter-info-${index}`}>
                <span className="font-medium">{t.submitter}</span> {demand.submitter.firstName} {demand.submitter.lastName}
              </div>
...
describe('Content Display Internationalization E2E Tests', () => {
  ...
  describe('English Content Display', () => {
    it('should display all English interface elements correctly', () => {
      ...
      expect(screen.getByTestId('search-input')).toHaveAttribute('placeholder', 'Search demands...');
    ...
    it('should display English demand card content correctly', () => {
      ...
      expect(description).toHaveTextContent('The kitchen faucet is leaking and needs immediate repair');
  ...
  describe('French Content Display', () => {
    it('should display all French interface elements correctly', () => {
      ...
      expect(screen.getByTestId('search-input')).toHaveAttribute('placeholder', 'Rechercher des demandes...');
    ...
    it('should display French demand card content correctly', () => {
      ...
      const description = screen.getByTestId('demand-description-0');
      expect(description).toHaveTextContent('Le robinet de cuisine fuit et nécessite une réparation immédiate');
