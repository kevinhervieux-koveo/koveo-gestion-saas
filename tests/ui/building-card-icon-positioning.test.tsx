        ...
        <div className='grid md:grid-cols-2 gap-4'>
          <div className='space-y-3'>
            ...
            {building.managementCompany && (
              <div className='flex items-center gap-2'>
                <svg className='w-4 h-4 text-gray-500' viewBox='0 0 24 24'>
                  <path d='M3 21h18V8l-9-5-9 5v13z'></path>
                </svg>
          ...
          <div className='space-y-3'>
            ...
            {building.parkingSpaces && (
              <div className='flex items-center gap-2'>
                <svg className='w-4 h-4 text-gray-500' viewBox='0 0 24 24'>
                  <path d='M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18.4 10'></path>
                </svg>
          ...
          <div className='mt-4 pt-4 border-t'>
            ...
            <div className='flex flex-wrap gap-1'>
              {building.amenities.map((amenity: string, index: number) => (
                <span key={index} className='badge px-2 py-1 rounded text-xs border'>
                  {amenity}
                </span>
              ))}
            </div>
...
describe('Building Card Icon Positioning Tests', () => {
  ...
  describe('Header Icon Positioning', () => {
    it('should keep action icons within card boundaries for short building names', () => {
      ...
      const card =
        ...
        screen.getByTestId('building-card') ||
    ...
    it('should maintain icon positioning for "563 montée des pionniers, Terrebonne" card', () => {
      ...
      const editIcon =
        within(editButton).getByRole('img', { hidden: true }) || editButton.querySelector('svg');
      const deleteIcon =
        within(deleteButton).getByRole('img', { hidden: true }) ||
        deleteButton.querySelector('svg');
      const documentsIcon =
        within(documentsButton).getByRole('img', { hidden: true }) ||
        documentsButton.querySelector('svg');
    ...
    it('should handle very long building names without icon overflow', () => {
      ...
      const headerDiv = screen.getByText(testBuildings.veryLongName.name).parentElement
        ?.parentElement;
  ...
  describe('Responsive Icon Behavior', () => {
    ...
    it('should prevent icon overlapping with long text content', () => {
      ...
      const leftSection = screen.getByText(/1234 Boulevard Saint-Laurent/).parentElement
        ?.parentElement;
  ...
  describe('Edge Cases and Error Prevention', () => {
    ...
    it('should prevent icon layout breaks with permission restrictions', () => {
      ...
      roles.forEach((role) => {
        ...
        const header = screen.getByText('563 montée des pionniers, Terrebonne').parentElement
          ?.parentElement;
