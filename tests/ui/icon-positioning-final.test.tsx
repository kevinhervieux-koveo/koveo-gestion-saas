    ...
    >
      ...
      <div className='space-y-2'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <span className='text-sm' data-testid='units-text'>
...
describe('Icon Positioning Tests for Building Cards', () => {
  ...
  it('should maintain card dimensions regardless of content length', () => {
    ...
    const { rerender } = render(
      <BuildingCard building={testBuildings.problematic} userRole='admin' />
    );
  ...
  it('should handle different user roles without breaking icon layout', () => {
    ...
    roles.forEach((role) => {
      const { rerender } = render(
        <BuildingCard building={testBuildings.problematic} userRole={role} />
      );
