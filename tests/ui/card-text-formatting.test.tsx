    ...
    >
      ...
      <div className='flex justify-between items-start mb-3'>
        <div className='flex items-center gap-2'>
          <span className='text-sm font-medium text-gray-600 capitalize'>{demand.type}</span>
          <span
      ...
      <div className='space-y-1 text-xs text-gray-600'>
        ...
        <div className='flex justify-between'>
          ...
          <span className='ml-2 text-right'>{new Date(demand.createdAt).toLocaleDateString()}</span>
        </div>
      </div>
    </div>
  );
...
describe('Card Text Formatting Tests', () => {
  ...
  describe('Text Truncation and Overflow', () => {
    ...
    it('should truncate long residence unit numbers', () => {
      ...
      expect(residenceElement).toHaveAttribute(
        'title',
        testDemands.veryLongText.residence.unitNumber
      );
    });
  ...
  describe('Accessibility and Usability', () => {
    it('should provide tooltips for truncated text', () => {
      ...
      expect(residenceElement.getAttribute('title')).toBe(
        testDemands.longText.residence.unitNumber
      );
    });
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle special characters and unicode text', () => {
      const unicodeData = {
        ...
        status: 'approved',
        description:
          "Demande d'information avec des accents: été, hôtel, naïve. Also émojis: 🏠🔧💧",
