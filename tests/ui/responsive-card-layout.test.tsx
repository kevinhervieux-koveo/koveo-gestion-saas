...
const testDemand = {
  ...
  status: 'submitted',
  description:
    'The building entrance door is not closing properly and needs immediate attention to ensure security.',
  building: {
  ...
  describe('Breakpoint Transitions', () => {
    ...
    it('should maintain text truncation across all screen sizes', () => {
      const longTextDemand = {
        ...testDemand,
        description:
          'This is an extremely long description that should be truncated on all screen sizes to prevent layout issues and maintain visual consistency across the entire application interface.',
      };
