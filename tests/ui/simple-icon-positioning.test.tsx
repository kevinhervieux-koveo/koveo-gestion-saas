    ...
    >
      ...
      <div className='flex items-start justify-between mb-4'>
        <div className='flex-1 min-w-0'>
          <h3 className='text-lg font-semibold text-gray-900 truncate' data-testid='building-name'>
            {building.name}
          </h3>
        </div>
...
describe('Simple Icon Positioning Tests', () => {
  ...
  it('should contain action icons within card for "563 montée des pionniers, Terrebonne"', () => {
    render(<BuildingCard building={testBuildings.problematicName} userRole='admin' />);
  ...
  it('should properly position content icons with address text', () => {
    render(<BuildingCard building={testBuildings.problematicName} userRole='manager' />);
