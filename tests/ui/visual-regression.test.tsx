...
const getComputedLineClamp = (element: HTMLElement): string => {
  return (
    window.getComputedStyle(element).webkitLineClamp ||
...
const screenshotTestData = [
  ...
  },
  {
    ...
    status: 'submitted',
    description:
      'My apartment door lock is sticking and very difficult to open during cold weather',
    building: 'Unknown',
    residence: '',
  ...
  },
  {
    ...
    status: 'approved',
    description:
      'Could you please provide the schedule for building maintenance and cleaning activities',
    building: 'Unknown',
    residence: '',
    createdAt: '2025-08-19T00:00:00Z',
  },
  {
    ...
    status: 'under_review',
    description:
      'There is a water stain on my bedroom ceiling that appears to be getting worse over time',
    building: 'Unknown',
    residence: '',
    createdAt: '2025-08-19T00:00:00Z',
  },
  ...
  describe('Text Overflow Prevention', () => {
    ...
    it('should truncate building names that are too long', () => {
      const longBuildingDemand = {
        ...
        building:
          'Very Long Building Name That Would Overflow The Card Layout If Not Handled Properly',
      };
  ...
  describe('Responsive Text Handling', () => {
    it('should apply word-break for long unbreakable text', () => {
      const longWordDemand = {
        ...screenshotTestData[0],
        description:
          'Thisisanextremelylongwordthatwouldbreaklayoutifnothandledproperlywithwordbreaking',
      };
    ...
    it('should handle hyphenation for better text flow', () => {
      const hyphenationDemand = {
        ...screenshotTestData[0],
        description:
          'Maintenance request for building accessibility improvements and modernization',
      };
    ...
    it('should prevent content from breaking grid alignment', () => {
      const mixedContentData = [
        { ...screenshotTestData[0], description: 'Short' },
        {
          ...
          description:
            'This is a very long description that could potentially break the grid layout if text overflow is not handled properly',
