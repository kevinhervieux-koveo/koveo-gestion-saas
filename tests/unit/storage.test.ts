...
import type { InsertUser, InsertOrganization, InsertBuilding, InsertPillar, InsertFeature, InsertImprovementSuggestion } from '@shared/schema';
  ...
  describe('Development Pillar Operations', () => {
    ...
    describe('getPillars', () => {
      it('should return pillars sorted by order', async () => {
        ...
        const createdPillars = pillars.filter(p => p.name.includes('First') || p.name.includes('Second') || p.name.includes('Third'));
  ...
  describe('Feature Operations', () => {
    ...
    describe('createFeature', () => {
      ...
      it('should respect provided status and priority', async () => {
        const featureData = { ...mockFeatureData, status: 'in-progress' as const, priority: 'high' as const };
    ...
    describe('getFeaturesByStatus', () => {
      it('should filter features by status', async () => {
        ...
        await storage.createFeature({ ...mockFeatureData, status: 'in-progress', name: 'In Progress Feature' });
    ...
    describe('getPublicRoadmapFeatures', () => {
      it('should return only public roadmap features', async () => {
        ...
        await storage.createFeature({ ...mockFeatureData, isPublicRoadmap: false, name: 'Private Feature' });
  ...
  describe('Improvement Suggestions Operations', () => {
    ...
    describe('getTopImprovementSuggestions', () => {
      it('should return suggestions sorted by priority and creation time', async () => {
        ...
        await storage.createImprovementSuggestion({ ...mockSuggestionData, priority: 'Low', title: 'Low Priority' });
        await storage.createImprovementSuggestion({ ...mockSuggestionData, priority: 'Critical', title: 'Critical Issue' });
        await storage.createImprovementSuggestion({ ...mockSuggestionData, priority: 'High', title: 'High Priority' });
    ...
    describe('clearNewSuggestions', () => {
      it('should remove all suggestions with New status', async () => {
        ...
        await storage.createImprovementSuggestion({ ...mockSuggestionData, status: 'Acknowledged', title: 'Acknowledged' });
