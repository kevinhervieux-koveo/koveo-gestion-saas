...
import CommonSpacesPage from '../../../client/src/pages/residents/common-spaces';
...
describe('Residents CommonSpacesPage HOC regression — withHierarchicalSelection + wouter mount', () => {
  beforeEach(() => {
  ...
  it('mounts without throwing an Invalid hook call error', () => {
    wouter.__setLocation('/residents/common-spaces');
