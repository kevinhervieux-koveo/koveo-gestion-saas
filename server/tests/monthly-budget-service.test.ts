...
describe('Monthly Budget Service', () => {
  ...
  describe('deriveIncomeAndSpendingTypes', () => {
    ...
    it('should derive spending types from money flow data', async () => {
      ...
      expect(budgetWithSpending[0].spendingAmounts.length).toBe(
        budgetWithSpending[0].spendingTypes.length
      );
    });
    ...
    it('should calculate correct totals', async () => {
      ...
      const expectedSpendingTotal = budget[0].spendingAmounts.reduce(
