    ...
    try {
            ...
            sections: [
              {
                ...
                content: "Koveo Gestion a été fondée avec la vision de révolutionner la gestion immobilière au Québec en offrant des solutions technologiques avancées et conformes aux réglementations provinciales.",
                year: "2020"
              },
              {
                title: "Développement et Croissance",
                content: "Nous avons développé notre plateforme en gardant à l'esprit les besoins spécifiques des gestionnaires immobiliers québécois et la conformité avec la Loi 25 sur la protection des renseignements personnels.",
                year: "2021-2022"
              },
              {
                title: "Innovation Continue",
                content: "Notre engagement envers l'innovation nous pousse constamment à améliorer nos services et à intégrer les dernières technologies pour offrir la meilleure expérience possible à nos clients.",
                year: "2023-Présent"
              }
            ],
            mission: "Simplifier la gestion immobilière au Québec grâce à des outils numériques intuitifs, sécurisés et conformes aux normes québécoises.",
            values: [
      ...
      if (metadata.contentType === 'application/pdf') {
        ...
        return res.json({
          ...
          message: "PDF trouvé - utilisez le lien de téléchargement pour accéder au contenu complet."
        });
      }
      ...
      return res.json({
        ...
        content: {
          ...
          sections: [
            {
              title: "Mission",
              content: "Koveo Gestion s'engage à fournir des solutions de gestion immobilière innovantes et conformes aux réglementations québécoises, notamment la Loi 25 sur la protection des renseignements personnels.",
              year: "2020-Présent"
            }
          ],
